  ...
  async sendEmail(email: string, expense: any): Promise<boolean> {
    ...
    try {
      ...
      const sendEmail = await axios.post(`${emailUrl}/v1/emails/template`, {
        "template": "default",
        "subject": "Your Monthly Income Analysis Is Here",
        ...
        "data": {
          ...
          "message": [    
            `<p style="font-size: 16px;">Your bank statement has been successfully analyzed by Mizala. The insights from your statement are now ready for you to view.</p> <br/>`,
